...
# Download required SDL libraries
def download_sdl_libraries():
    """Download SDL2.dll and SDL2_mixer.dll if they don't exist, with automatic renaming"""
    files = [
        {
    ...
    for file_info in files:
        ...
        if not os.path.exists(file_info["expected_name"]):
            ...
            try:
                ...
                print(f"Successfully downloaded {file_info['expected_name']}")
